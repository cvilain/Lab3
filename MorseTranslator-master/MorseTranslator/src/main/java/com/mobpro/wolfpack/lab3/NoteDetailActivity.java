...
public class NoteDetailActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        final String name = intent.getStringExtra("name").toLowerCase();
        ...
        vibrateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //vibrate
                long[] morse = readMorse(name);
                vibrator.vibrate(morse, -1);//new long[]{1000,500,1000}, -1);
            }
        });
        ...
        morseText.setText(englishToMorse(name));
    }
    ...
    public String englishToMorse(String english){
        ...
        for (int i = 0; i < characters.length; i++){
            if(this.MORSE.containsKey(characters[i])){
                ...
                //morseCode.add("___");
                morseText = morseText + MORSE.get(characters[i]) + "___";
            }
            else if (characters[i] == " "){
                //morseCode.add("____");
                morseText = morseText + "____";
            }
            else {}
        }
        //return morseCode;
    ...
    public long[] readMorse(String english){
        String[] characters = english.split("");
